...
public class StatusBarReceiver extends BroadcastReceiver {
    public static final String ACTION_STATUS_BAR = "com.charles.funmusic.receiver.STATUS_BAR_ACTIONS";
    public static final String EXTRA = "extra";
    public static final String EXTRA_NEXT = "next";
    public static final String EXTRA_PLAY_PAUSE = "play_or_pause";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (TextUtils.equals(extra, EXTRA_NEXT)) {
            ...
            PlayService.startCommand(context, Actions.ACTION_MEDIA_EXIT);
        }
    }
}
