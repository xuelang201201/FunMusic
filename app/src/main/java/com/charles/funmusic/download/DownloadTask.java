...
public class DownloadTask implements Runnable {
    ...
    public DownloadTask(Context context) {
        ...
        mDownloadStore = DownloadStore.getInstance(context);
    }
    ...
    public void run() {
        ...
        try {
            dbEntity = mDownloadStore.getDownLoadedList(id);
            ...
            if (fileLength != 0 && totalSize == fileLength) {
                ...
                mDownloadStore.insert(dbEntity);
            ...
            if (responseBody != null) {
                ...
                while ((length = bis.read(buffer)) > 0 && downloadStatus != DownloadStatus.DOWNLOAD_STATUS_CANCEL && downloadStatus != DownloadStatus.DOWNLOAD_STATUS_PAUSE) {
                    ...
                    if (buffOffset >= UPDATE_SIZE) {
                        ...
                        mDownloadStore.update(dbEntity);
                        onDownloading();
                    }
                }
...
//            e.printStackTrace();
        ...
        switch (downloadStatus) {
            ...
            case DownloadStatus.DOWNLOAD_STATUS_CANCEL:
                mDownloadStore.deleteTask(dbEntity.getDownloadId());
    ...
    public void setDownloadStore(DownloadStore DownloadStore) {
        this.mDownloadStore = DownloadStore;
    }
