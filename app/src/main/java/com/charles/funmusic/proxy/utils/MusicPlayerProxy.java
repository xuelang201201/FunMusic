 ...
 * 代理
 */
public class MusicPlayerProxy implements Runnable {
    private static final String LOG_TAG = MusicPlayerProxy.class.getSimpleName();
    ...
    static RequestDealThread downloadThread;
    private Context mContext;

    public MusicPlayerProxy(Context mContext) {
